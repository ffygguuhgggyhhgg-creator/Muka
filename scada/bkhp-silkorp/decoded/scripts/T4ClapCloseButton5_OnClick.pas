begin
if T4ClapLatchCalCloseTime5.Value > 0 then  // Условие пуска по выполненной калибровке
begin
...
begin
T4ClapCloseStatus5.Value := True;
T4ClapBlockSelectStatus.Value := True;
AddMessage(Now, mkWarning , 'Начало переброса клапана Транспортера 4 в Силос 15!', True, True);
end;
end;
end;                                                                                   
if T4ClapLatchCalCloseTime5.Value = 0 then
begin
