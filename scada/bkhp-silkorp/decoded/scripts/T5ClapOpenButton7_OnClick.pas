begin
if T5ClapLatchCalOpenTime7.Value > 0 then  // Условие пуска по выполненной калибровке
begin
...
begin
T5ClapOpenStatus7.Value := True;
T5ClapBlockSelectStatus.Value := True;
AddMessage(Now, mkWarning , 'Начало переброса клапана Транспортера 5 в Силос 29!', True, True);
end;
end;
end;
if T5ClapLatchCalOpenTime7.Value = 0 then
begin
