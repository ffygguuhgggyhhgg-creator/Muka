begin
if T4ClapLatchCalOpenTime6.Value > 0 then  // Условие пуска по выполненной калибровке
begin
...
begin
T4ClapOpenStatus6.Value := True;
T4ClapBlockSelectStatus.Value := True;
AddMessage(Now, mkWarning , 'Начало переброса клапана Транспортера 4 в Силос 6!', True, True);
end;
end;
end;
if T4ClapLatchCalOpenTime6.Value = 0 then
begin
