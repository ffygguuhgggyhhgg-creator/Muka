...
if T5LatchCalOpenTime5.Value > 0 then  // Условие пуска по выполненной калибровке
begin
...
begin
AddMessage(Now, mkAlarm, 'Произведите калибровку открытия задвижки Транспортера 5 Силос 27-37! Время открытия равно нулю!', True, True);
end;
