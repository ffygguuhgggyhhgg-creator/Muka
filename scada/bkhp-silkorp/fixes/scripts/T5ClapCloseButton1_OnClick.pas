...
if T5ClapLatchCalCloseTime1.Value > 0 then  // Условие пуска по выполненной калибровке
begin
...
begin
T5ClapCloseStatus1.Value := True;
T5ClapBlockSelectStatus.Value := True;
AddMessage(Now, mkWarning , 'Начало переброса клапана Транспортера 5 в Силос 33!', True, True);
end;
end;
end;
if T5ClapLatchCalCloseTime1.Value = 0 then
begin
