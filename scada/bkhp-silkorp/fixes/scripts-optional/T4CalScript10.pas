...
if T4CalTimer10.Value > 600 then // предельное время калибровки, 10 мин
begin
T4LatchRunOpen.Value := False;
T4LatchRunClose.Value := False;
T4BlockSelectStatus.Value := False;
T4LatchStatusByte10.Value := 5;
T4CalStatus10.Value := False;
T4LatchSelect10.Value := False;
T4CalTimer10.Value := 0;
