...
if T5ClapCalTimer8.Value > 600 then // предельное время калибровки, 10 мин
begin
T5ClapLatchRunOpen.Value := False;
T5ClapLatchRunClose.Value := False;
T5ClapBlockSelectStatus.Value := False;
T5ClapLatchStatusByte8.Value := 5;
T5ClapCalStatus8.Value := False;
